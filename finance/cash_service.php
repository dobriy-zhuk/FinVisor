...
<html class="no-js">
    <head>
        ...
        <title>Рассчетно-кассового обслуживание для юридических лиц и ип, обзор тарифов российских банков</title>
        <meta name="description" content="Предлагаем подобрать смые выгодные тарифы и условия рассчетно-кассового обслуживания для юридических лиц и индивидуальных предпринимателей.">
        <meta name="keywords" content="рко, расчетный счет, кассовое, обслуживание, бизнес, ип, преприниматель, тарифы, юридические лица, сбербанк, тинькофф, альфа, втб, банк, банки, space, finance, spacefinance">
        ...
        <script async type="text/javascript">
           ...
           function get_cash_services(){
                   ...
                   success:function(response){
                       ...
                       result.forEach(function(element){
                           document.getElementById('result').innerHTML += '<tr class="product_card">' +
                               ...
                               '<td class="active" style="text-align: center; vertical-align: middle;">' + element.open_fee + ' руб.<br><button class=\"btn btn-success\" onclick="forward(\'' + element.name_institution + '\')"> Подать заявку </button>' + '</td>' +
                               '</tr>' +
            ...
            function forward(name_institution){
                ...
                mymodal.find('.modal-title').text("Заявление на открытие РКО в " + name_institution);
                mymodal.modal('show');
