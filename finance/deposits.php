...
<html class="no-js">
    <head>
        ...
        <title>Депозиты для юридических лиц и индивидуальных предпринимателей</title>
        <meta name="description" content="Подбор депозитов с высокими ставками для малого и среднего бизнеса из более 500 предложений Российских банков">
        <meta name="keywords" content="депозиты, бизнес, вклады, ставки, высокие, юридические, лица, ип, space, finance, spacefinance">
                   ...
                   success:function(response){
                       ...
                       result.forEach(function(element){
                           document.getElementById('result').innerHTML += '<tr class="product_card">' +
                               ...
                               '<td style="text-align: center; vertical-align: middle;">от ' + element.min_balance + ' руб.</td>' +
                               '<td class="active" style="text-align: center; vertical-align: middle;">до ' + element.interest_rate + '%<br><button class=\"btn btn-success\" onclick="forward(\'' + element.name_institution + '\')"> Открыть депозит</button>' + '</td>' +
                               '</tr>' +
                               '<tr><td style="border: none" colspan="3"><a style="font-size: 15px; cursor: pointer" data-toggle="collapse" data-target="#collapseExample' + element.id + '" aria-expanded="false" aria-controls="collapseExample' + element.id + '">' +
                               'Особенности' +
            ...
            <div class="col-xs-3">
                <div class="form-group">
                    ...
                    <select id="min_balance" class="selectpicker form-control">
                        <option value="0">Не имеет значения</option>
                        <option value="100000">от 100тыс. руб</option>
                        <option value="1000000">от 1млн. руб</option>
                    </select>
                </div>
            </div>
            <div class="col-xs-3">
