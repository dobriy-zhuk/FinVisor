...
<html class="no-js">
    <head>
        ...
        <title>Кредит на пополнение оборотного капитала | Взять кредит под оборотные средства для юридических лиц и индивидуальных предпринимателей</title>
        <meta name="description" content="Подбор наиболее выгодных оборотных кредитов в банках предоставляемых для малого и среднего бизнеса по всей России">
        <meta name="keywords" content="кредит, кредиты, сбербанк, тинькофф, альфа, втб, промсвязьбанк, малый, бизнес, оборотный, пополнение, капитал, средства, заем, получить, space, finance, spacefinance">
        ...
        <script async type="text/javascript">
           ...
           function get_credit_capital(){
                   ...
                   success:function(response){
                       ...
                       result.forEach(function(element){
                           document.getElementById('result').innerHTML += '<tr class="product_card">' +
                               ...
                               '<td class="active" style="text-align: center; vertical-align: middle;">до ' + element.max_credit + ' млн. руб.<br><button class=\"btn btn-success\" onclick="forward(\'' + element.name_institution + '\')"> Заявка на кредит</button>' + '</td>' +
                               '</tr>' +
            ...
            function forward(name_institution){
                ...
                mymodal.find('.modal-title').text("Заявление на кредитование (оборотный капитал) в " + name_institution);
                mymodal.modal('show');
                  ...
                  <div class="row fill">
                   ...
                   <div class="row">
                       <div class="col-md-8 col-md-push-2 top-offset center-block">
                          <h1><strong>Кредит на пополнение оборотного капитала</strong></h1>
                          <p><i>Подберите лучшие условия для кредита на пополнение оборотного капитала</i></p>
                       </div>
                    </div>
    </div>
