...
<html class="no-js">
    <head>
        ...
        <title>Подбор наиболее выгодного кредитования для малого и среднего бизнеса</title>
        <meta name="description" content="Подбор выгодного кредитования для вашего бизнеса">
        <meta name="keywords" content="кредит, кредитование, для бизнеса">
                   ...
                   success:function(response){
                       ...
                       result.forEach(function(element){
                           document.getElementById('result').innerHTML += '<tr class="product_card">' +
                               ...
                               '<td class="active" style="text-align: center; vertical-align: middle;">' + element.max_credit + 'руб.<br><button class=\"btn btn-success\" onclick="forward(\'' + element.id + '\',\'' + element.name_institution + '\')"> Подать заявку на кредит</button>' + '</td>' +
                               '</tr>' +
            ...
            <div class="col-xs-3">
                <div class="form-group">
                    ...
                    <select id="interest_rate" class="selectpicker form-control">
                        ...
                        <option value="30" selected>До 30%</option>
                    </select>
                </div>
            </div>
            <div class="col-xs-3">
            ...
            <div class="col-xs-3">
                <div class="form-group">
                    ...
                    <select id="max_credit" class="selectpicker form-control">
                        ...
                        <option value="100000">До 100 тыс. руб.</option>
                        <option value="3000000">До 3 млн. руб.</option>
                        <option value="10000000" selected>До 10 млн. руб.</option>
                    </select>
                </div>
            </div>
        </div>
