...
<html class="no-js">
    <head>
        ...
        <meta name="description" content="Подбор лучшего онлайн-брокера для малого и среднего бизнеса">
        <meta name="keywords" content="брокеры, форекс, бинарные, помощь, лучшие, открытие, личный онлайн, для бизнеса, акции, облигации, фьючерсы, инвесторы, space, finance, spacefinance">
                   ...
                   success:function(response){
                       ...
                       result.forEach(function(element){
                           document.getElementById('result').innerHTML += '<tr class="product_card">' +
                               ...
                               element.details +
                               '</td>' +
                               '<td style="text-align: center; vertical-align: middle;">' + '<a title="element">от ' + element.commission + '%</a></td>' +
                               '<td style="text-align: center; font-size: 14px; vertical-align: middle;">' + element.instruments + '</td>' +
