...
<html class="no-js">
    <head>
        ...
        <title>Конкурсы на получение инвестиций и грантов для малого и среднего бизнеса | Подать заявку</title>
        <meta name="description" content="Все финансовые конкурсы на получение инвестиций, грантов и субсидий для малого и среднего бизнеса">
        <meta name="keywords" content="венчрные, фонды, финансирование, для бизнеса, гранты, инвестиции, инвесторы, ангел,  заявка, проект, предпринимательство, space, finance, spacefinance">
        ...
        <script async type="text/javascript">
           ...
           function get_contest(){
                   ...
                   success:function(response){
                       ...
                       result.forEach(function(element){
                           document.getElementById('result').innerHTML += '<tr class="product_card">' +
                               ...
                               '<td class="active" style="text-align: center; vertical-align: middle;">' + element.volume + 'млн.руб.<br><button class=\"btn btn-success\" onclick="forward(\'' + element.name_institution + '\')"> Подать заявку на участие</button>' + '</td>' +
                               '</tr>' +
            ...
            function forward(name_institution){
                ...
                mymodal.find('.modal-title').text("Заявка на участие в конкурсе " + name_institution);
                mymodal.modal('show');
                                       ...
                                       <div class="col-xs-4">
                                           <div class="form-group">
                                               ...
                                               <select id="volume" class="selectpicker form-control">
                                                   ...
                                                   <option value="0.1">От 100 тыс. руб.</option>
                                                   <option value="1">От 1 млн. руб.</option>
                                                   <option value="10" selected>От 10 млн. руб.</option>
                                               </select>
                                           </div>
                                       </div>
                                   </div>
