                    ...
                    success:function(response){
                        ...
                        result.forEach(function(element){
                            document.getElementById('result').innerHTML += '<tr class="product_card">' +
                                ...
                                '<td style="text-align: center; vertical-align: middle;">' + element.rating + ' руб.</td>' +
                                '<td class="active" style="text-align: center; vertical-align: middle;">до ' + element.price + '%<br><button class=\"btn btn-success\" onclick="forward(\'' + element.id + '\',\'' + element.name_institution + '\')"> Открыть депозит</button>' + '</td>' +
                                '</tr>' +
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <ul class="multi-column-dropdown">
                                            ...
                                            <li><a href="insurance_finance.php">Финансовая деятельность</a></li>
