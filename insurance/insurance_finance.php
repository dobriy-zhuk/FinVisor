...
<html class="no-js">
    <head>
        ...
        <title>Страхование коммерческих и финансовых рисков | Подберите лучшие условия для юридических лиц и индивидуальных предпринимателей</title>
        <meta name="description" content="Обзор страховых компаний по страхованию финансовых и коммерческих рисков для малого и среднего бизнеса">
        <meta name="keywords" content="страхование, страховка, финансовые, коммерческие, бизнес, риски, страховые, сбербанк, тинькофф, тарифы, альфа, союз, реннесанс, предпринимательская", space, finance, spacefinance>
        ...
        <script async type="text/javascript">
                    ...
                    success:function(response){
                        ...
                        result.forEach(function(element){
                            document.getElementById('result').innerHTML += '<tr class="product_card">' +
                                ...
                                '</td>' +
                                '<td style="text-align: center; font-size: 14px; vertical-align: middle;">' + element.risks + '</td>' +
                                '<td style="text-align: center; vertical-align: middle;">' + element.rating + '</td>' +
                                '<td class="active" style="text-align: center; vertical-align: middle;">' + element.price + '<br><button class=\"btn btn-success\" onclick="forward(\'' + element.name_institution + '\')"> Заявление на страхование</button>' + '</td>' +
                                '</tr>' +
            ...
            function forward(name_institution){
                ...
                mymodal.find('.modal-title').text("Заявление на страхование финансовых рисков в " + name_institution);
                mymodal.modal('show');
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal-title">Заявка на страхование финансовых рисков</h4>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-push-2 top-offset center-block">
                <h1><strong>Страхование финансовых рисков для бизнеса</strong></h1>
                <p><i>Выбирайте лучшие варианты страхования финансовой деятельности для вашего бизнеса</i></p>
                <form onchange="changed_form()">
                    <div class="form-group">
                        <select id="type_insurance" class="selectpicker form-control">
                            ...
                            <option value="finance" selected>Страхование финансовой деятельности</option>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <ul class="social">
                            <li>
                                <a href="https://www.facebook.com/spacefinance/" target="_blank" class="Facebook">
                                    <i class="fa fa-facebook"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://vk.com/spacefinance" target="_blank" class="Facebook">
                                    <i class="fa fa-vk"></i>
                                </a>
                            </li>
                            <li>
