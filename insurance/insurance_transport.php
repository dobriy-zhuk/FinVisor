...
<html class="no-js">
    <head>
        ...
        <title>Страхование транспорта юридических лиц и индивидуальных предпринимателей</title>
        <meta name="description" content="Подберите лучшие условия по страхованию автотранспорта для малого и среднего бизнеса">
        <meta name="keywords" content="страхование, страховка, авто, автомобиль, транспорт, страховые, сбербанк, тинькофф, тарифы, альфа, союз, реннесанс, предпринимательская, space, finance, spacefinance">
        ...
        <script async type="text/javascript">
                    ...
                    success:function(response){
                        ...
                        result.forEach(function(element){
                            document.getElementById('result').innerHTML += '<tr class="product_card">' +
                                ...
                                '<td class="active" style="text-align: center; vertical-align: middle;">' + element.price + '<br><button class=\"btn btn-success\" onclick="forward(\'' + element.name_institution + '\')"> Заявка на страхование</button>' + '</td>' +
                                '</tr>' +
            ...
            function forward(name_institution){
                ...
                mymodal.find('.modal-title').text("Заявление на страхование транспорта в " + name_institution);
                mymodal.modal('show');
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal-title">Заявка на страхование транспорта</h4>
                </div>
