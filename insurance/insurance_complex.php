                    ...
                    success:function(response){
                        ...
                        result.forEach(function(element){
                            document.getElementById('result').innerHTML += '<tr class="product_card">' +
                                ...
                                element.details +
                                '</td>' +
                                '<td style="text-align: center; vertical-align: middle;">' + '<a title="element">' + element.risks + ' <i class="ion ion-ios-information-outline"></i></a></td>' +
                                '<td style="text-align: center; vertical-align: middle;">' + element.rating + '</td>' +
                                '<td class="active" style="text-align: center; vertical-align: middle;">' + element.price + '<br><button class=\"btn btn-success\" onclick=forward("' + element.logo_bank + '");> Рассчитать стоимость</button>' + '</td>' +
                                '</tr>';
                        });
